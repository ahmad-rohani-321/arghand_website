<body id="savon-theme" class=" body-boxed template-index  others " style="">
...
<li class="2 promo_image
  ...
  <div class="sub-menu-block is-hidden">
    ...
    <div class="see-all"></div>
    <div class="dt-sc-dropdown-menu dt-sc--main-menu--mega  dt-sc_main-menu--has-links" id="collections-3-dt-sc-menu">
      <ul class="sub-menu-lists  dt-sc-column four-sixth-one-third   "><li class="">
          <h5> <a href="collections/ayurvedic-soap.html" >
            Ayurvedic Soap
            </a>
          </h5><ul><li class="">
              <a href="products/citrus-soap.html" >
                Citrus Soap
              </a>
            </li><li class="">
              <a href="products/pink-clay-soap.html" >
                Pink Clay Soap
              </a>
            </li><li class="">
              <a href="#" >
          ...
          <h5> <a href="collections/handmade-soap.html" >
            Handmade Soap
            </a>
          </h5><ul><li class="">
              <a href="products/herbal-soap.html" >
                Herbal Soap
              </a>
            </li><li class="">
              <a href="products/rose-lavendar-soap.html" >
                Rose & Lavendar Soap
              </a>
            </li><li class="">
              <a href="#" >
          ...
          <h5> <a href="collections/herbal-soap.html" >
            Herbal Soap
            </a>
          </h5><ul><li class="">
              <a href="products/lavender-soap.html" >
                Lavender Soap
              </a>
            </li><li class="">
              <a href="products/rose-soap.html" >
                Rose Soap
              </a>
            </li><li class="">
              <a href="#" >
          ...
          <h5> <a href="collections/luxury-soap.html" >
            Luxury Soap
            </a>
          </h5><ul><li class="">
              <a href="products/mixed-herb-soap.html" >
                Mixed Herb Soap
              </a>
            </li><li class="">
              <a href="products/sandal-wood-soap.html" >
                Sandal Wood Soap
              </a>
            </li><li class="">
              <a href="#" >
  ...
  <div class="dt-sc-mega_menu text-center"><a href="collections.html"  class="dt-sc-mega_menu-link"><img class="lazyload"
         src="/assets/loading.gif"
         data-src="/assets/files/Savon_Mega_Menu_-_3_640061f4-3419-4b34-9203-ccc8e9b9687e7fd5.png"
         data-widths="[180, 360, 470, 600, 770, 970, 1060, 1280, 1512, 1728, 2048]"
         data-aspectratio="1.775"
         data-sizes="auto"            
         alt="">            
    <noscript>
      <img src="/assets/files/Savon_Mega_Menu_-_3_640061f4-3419-4b34-9203-ccc8e9b9687e_480x480%402x7fd5.png" class="dt-sc-noscript-image" />
    </noscript></a><div class="dt-sc-details"></div>
  </div>
</li><!-- Image with text  End-->
<!-- Image with text --><!-- Image with text  End-->
...
<li class="0 text-menu
           top-level-link 
            ...
            ">
  <a href="pages/contact.html" class="  dt-sc-nav-link dropdown"> 
    Contact 
  </a>
...
<style>
  ...
  ul.dt-sc-list-inline > li ul.sub-menu-lists > li > ul a{ display: inline-block; font-size: 13px; padding: 8px 0; width: 100%; }
